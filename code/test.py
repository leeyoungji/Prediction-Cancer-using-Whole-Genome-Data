...
parser.add_argument('--l0', type=int, default=44900, help='maximum length of input sequence to CNNs [default: 1014]')
...
if __name__ == '__main__':
    ...
    # _, num_class_test = test_dataset.get_class_weight() #getClassWeight()
    ...
    print('\rEvaluation - acc: {:.3f}%({}/{}) '.format(accuracy,
                                                       corrects,
                                                       size))
